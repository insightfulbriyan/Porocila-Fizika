...
# ax[0].plot(x[0][:495], amplituda_x*np.sin(2*np.pi*frekvenca*(x[0][:495] - 0.0852)), label="3. poskus")
# ax[0].set(xlim=(0, 10), ylim=(-0.5, 0.5), ylabel='odmik (m)', title="$s(t)$")
# ax[0].grid()


# ax[1].plot(x[0][:495], x[5][:495], label="2. poskus", color="blue")
# # ax[1].plot(x[0][:495], x[8][:495], label="3. poskus")
# ax[1].plot(x[0][:495], dxdy(amplituda_x*np.sin(2*np.pi*frekvenca*(x[0] - 0.0852)), end=495), label="odvod poti", color="orange")
# # ax[1].plot(x[0][:495], amplituda_v*np.sin(2*np.pi*frekvenca*(x[0][:495] - 0.7950530907)), label="3. poskus", color="green")
# ax[1].set(xlim=(0, 10), ylim=(-2, 2), ylabel='odmik (m)', title="$v(t)$")
# ax[1].grid()

# ax[2].plot(x[0][:495], x[6][:495], label="2. poskus", color="blue")
# # ax[2].plot(x[0][:495], dxdy(x[5], length=495), label="2. poskus", color="orange")
# ax[2].plot(x[0][:495], dxdy(dxdy(amplituda_x*np.sin(2*np.pi*frekvenca*(x[0] - 0.0852))), end=495), label="2. poskus", color="green")
# # ax[2].plot(x[0][:495], np.diff(x[9])[:495]/np.diff(x[0])[:495], label="3. poskus")
# ax[2].set(xlim=(0, 10), ylim=(-20, 20), ylabel='odmik (m)', title="$v(t)$")
# ax[2].grid()
# plt.show()
